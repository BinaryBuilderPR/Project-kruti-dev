...
namespace KrutiDevWordAddIn
{
    ...
    public static class KrutiDevConverter
    {
        ...
        private static readonly Dictionary<string, string> DirectUnicodeToKruti = new Dictionary<string, string>
        {
            ...
            {"राँची", "jkWaph"}, {"सरायकेला", "ljk;dsyk"}, {"खरसावाँ", "[kjlkokWa"}, {"प्राथमिक", "izkFkfed"},
            {"माध्यमिक", "ek/;fed"}, {"उच्च", "mPp"}, {"न्यायालय", "U;k;ky;"}, {"पदाधिकारी", "inkf/kdkjh"},
            {"अधीक्षक", "v/kh{kd"}, {"निदेशक", "funs'kd"}, {"आदेश", "vkns'k"}, {"ज्ञापांक", "Kkikad"},
            {"पत्रांक", "i=kad"}, {"दिनांक", "fnukad"}, {"प्रतिवेदन", "izfrosnu"}, {"अनुपालन", "vuqikyu"},
            {"संचिका", "lafpdk"}, {"भवदीय", "Hkonh;"}, {"हस्ताक्षर", "gLrk{kj"}, {"विषय", "fo\"k;"},
            {"प्रसंग", "izlax"}, {"महोदय", "egksn;"}, {"अनुरोध", "vuqjks/k"}, {"आवश्यक", "vko';d"},
            {"कार्रवाई", "dk;Zokgh"}, {"कार्यवाही", "dk;Zokgh"}, {"उपरोक्त", "mijksDr"}, {"संलग्न", "layXu"},
            {"वेतन", "osru"}, {"शिक्षक", "f'k{kd"}, {"शिक्षिका", "f'kf{kdk"}, {"विद्यालय", "fon~;ky;"},
            {"प्रधानाध्यापक", "iz/kkuk/;kid"}, {"प्रभारी", "izHkkjh"}, {"छात्र", "Nk="}, {"छात्रा", "Nk=k"},
            {"उपस्थिति", "mifLFkfr"}, {"अवकाश", "vodk'k"}, {"स्वीकृत", "Lohd`r"}, {"अस्वीकृत", "vLohd`r"},
            {"स्पष्टीकरण", "Li\"Vhdj.k"}, {"शोकॉज", "'kksdkWt"}, {"जाँच", "tkWap"}, {"निलंबन", "fuyacu"},
            {"वेतनमान", "osrueku"}, {"में", "esa"}, {"मैं", "eSa"}, {"की", "dh"}, {"कि", "fd"},
            {"के", "ds"}, {"को", "dks"}, {"से", "ls"}, {"पर", "ij"}, {"का", "dk"}, {"है", "gS"},
            {"हैं", "gSa"}, {"था", "Fkk"}, {"थी", "Fkh"}, {"थे", "Fks"}, {"होगा", "gksxk"},
            {"किया", "fd;k"}, {"गया", "x;k"}, {"गए", "x,"}, {"गई", "xbZ"}, {"जाता", "tkrk"},
            {"द्वारा", "}kjk"}, {"तथा", "rFkk"}, {"एवं", ",oa"}, {"अथवा", "vFkok"}, {"यदि", ";fn"},
            {"तो", "rks"}, {"इस", "bl"}, {"उस", "ml"}, {"सभी", "lHkh"}, {"आदेशानुसार", "vkns'kkuqlkj"}
        };
